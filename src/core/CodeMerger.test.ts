import { CodeBlockMerger } from "./CodeMerger"

import { expect, jest, test } from '@jest/globals'

describe('CodeBlockMerger', () => {
    let codeMerger: CodeBlockMerger
    beforeEach(() => {
        codeMerger = new CodeBlockMerger()
    })
    ...
    test('should merge overlapping code blocks', () => {
        const codeBlocks = [
            `<code>class A { method1() { console.log('A1'); } }</code>`,
    ...
    test('should handle multiple classes and functions', () => {
        const codeBlocks = [
            `<code>class A { method1() { console.log('A1'); } }</code>`,
    ...
    test('should handle updates to existing code', () => {
        const codeBlocks = [
            `<code>class A { method1() { console.log('A1'); } }</code>`,
