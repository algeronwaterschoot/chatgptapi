...
function PreprocessArgs() {
    return (target, propertyKey, descriptor) => {
        ...
        descriptor.value = function (...args) {
            ...
            const defaultCallbacks = FlowchatPluginManager.getDefaultCallbacks(targetClass, propertyKey);
            const instanceCallbacks = FlowchatPluginManager.getInstanceCallbacks(this, propertyKey);
...
FlowchatPluginManager.addDefaultCallback(MyClass, 'myMethodA', args => args.map(arg => arg.toUpperCase()));
const instance1 = new MyClass();
const instance2 = new MyClass();
// Add an instance-specific preprocessing callback for instance1.myMethodA
FlowchatPluginManager.addInstanceCallback(instance1, 'myMethodA', args => args.map(arg => `${arg}!`));
// Add an instance-specific preprocessing callback for instance2.myMethodB
FlowchatPluginManager.addInstanceCallback(instance2, 'myMethodB', args => args.map(arg => arg.toLowerCase()));
...
//# sourceMappingURL=FlowchatTuner.js.map