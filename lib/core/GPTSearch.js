...
exports.search = exports.configureSearch = exports.SearchScope = exports.ChatGPTMessageSearch = exports.GPTMessageSearch = void 0;
...
function configureSearch(messageSearch, scope = SearchScope.Parents) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (searchScopes[scope])
            GPTPlugin_1.GPTPlugin.add(messageSearch, 'searchInHaystacks', 'Before', searchScopes[scope]);
        return messageSearch;
    });
}
exports.configureSearch = configureSearch;
function search(branch, filter = (message) => true) {
    return __awaiter(this, void 0, void 0, function* () {
        const messageSearch = new MessageSearch(branch);
        const scope = SearchScope.Children;
        let searchResults = yield (yield configureSearch(messageSearch, scope)).byCallback(filter);
        searchResults.sort((a, b) => { var _a, _b; return ((_a = a.body.sequence) !== null && _a !== void 0 ? _a : 0) - ((_b = b.body.sequence) !== null && _b !== void 0 ? _b : 0); });
