...
exports.FlowChatMessageLogMockGPTAPI = exports.ChatGPTAPI = exports.GPTAPI = void 0;
const fs = require("fs");
...
function getMockResponse(content, logs) {
    const responses = [];
    for (let i = responseIndex; i < logs.length; i++) {
        try {
...
class FlowChatMessageLogMockGPTAPI extends GPTAPI {
    fetch(request) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.FlowChatMessageLogMockGPTAPI = FlowChatMessageLogMockGPTAPI;
